...
class ServerUpdater {
  ...
  factory ServerUpdater.fromJson(Map<int, dynamic> json) {
    return ServerUpdater(
      version: json['version' as int] as int?,
      versionName: json['version_name' as int] as String?,
      changelog: json['changelog' as int] as String?,
      mandatory: json['mandatory' as int] as bool?,
    );
  }
}
...
class Update extends Core {
  ...
  Future<ServerUpdater?> _returnServerInfo() async {
    ...
    var res = await http.get(Uri.encodeFull(link) as Uri,
  ...
  Future<bool> isUpdateAvailable() async {
    var info = await (_returnServerInfo() as Future<ServerUpdater>);
